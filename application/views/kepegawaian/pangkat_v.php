                    ...
                    <div class="card-body">
                        ...
                        <form enctype="multipart/form-data" method="post" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                     <select name="id_golongan"class="selectpicker form-control form-control-sm" data-live-search="true" data-size="5" title="...">
                                         <?php foreach($golongan as $row) :?>
                                            <?php if ($row['id_golongan']==$this->input->post('id_golongan')) : ?>
                                                <option data-tokens="<?= $row['pangkat']?>" value="<?= $row['id_golongan']?>" selected><?= $row['id_golongan'].' - '.$row['pangkat']?></option>
                                            <?php else : ?>
                                                <option data-tokens="<?= $row['pangkat']?>" value="<?= $row['id_golongan']?>"><?= $row['id_golongan'].' - '.$row['pangkat']?></option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </select>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        ...
                                        <input  type="text" value="<?= $this->input->post('tanggal_sk') ?>" class="form-control datepicker form-control-sm" placeholder="Tanggal SK"name="tanggal_sk">
                                    </div>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        ...
                                        <input  type="text" class="form-control datepicker form-control-sm" placeholder="TMT golongan"name="tmt_golongan" value="<?=$this->input->post('tmt_golongan')?>">
                                    </div>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" value="<?= $this->input->post('file_sk') ?>" name="file_sk" id="filer_example2">
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                        <?= form_error('file_sk'); ?>
                                    </small>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                    <a class="btn btn-sm btn-secondary mr-4" href="<?=base_url();?>Profile/index/<?=$nip?>/sdkws">
                                        Kembali
                                    </a>
