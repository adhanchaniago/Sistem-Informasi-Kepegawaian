                    ...
                    <div class="card-body">
                        ...
                        <form enctype="multipart/form-data" method="post">
                            <div class="form-group row" <?= checkAkses() ?>>
                                ...
                                <div class="col-sm-9">
                                    <input type="hidden" name="id_fungsional" value="<?= $fungsional['id_fungsional'] ?>">
                                    <input type="hidden" name="status" value="<?= $fungsional['status'] ?>">
                                    <select name="nip"class="selectpicker form-control form-control-sm" data-live-search="true" data-size="3" title="...">
                                        <?php foreach($pegawai as $row) :?>
                                            <?php if ($row['nip']==$fungsional['nip']) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                     <select name="id_jabatan"class="selectpicker form-control form-control-sm" data-live-search="true" data-size="5" title="...">
                                         <?php foreach($jabatan as $row) :?>
                                            <?php if ($row['id']==$fungsional['id_jabatan']) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="status_fungsional" class="selectpicker form-control form-control-sm" data-live-search="true" data-size="3" title="...">
                                        <option value="Aktif" <?=checkOption('Aktif',$fungsional['status_fungsional'])?>>Aktif</option>
                                        <option value="Non Aktif" <?=checkOption('Non Aktif',$fungsional['status_fungsional'])?>>Non Aktif</option>
                                        <option value="Keluar" <?=checkOption('Keluar',$fungsional['status_fungsional'])?>>Keluar</option>
                                    </select>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                     <input type="text" class="form-control form-control-sm"  placeholder="No SK" name="no_sk" value="<?= $fungsional['no_sk'] ?>" >
                                     <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                        <?= form_error('no_sk'); ?>
                                    </small>
                                </div>
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        ...
                                        <input  type="text" class="form-control datepicker form-control-sm" placeholder="Tanggal SK"name="tanggal_sk" value="<?= $fungsional['tanggal_sk'] ?>" >
                                    </div>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        ...
                                        <input  type="text" class="form-control datepicker form-control-sm" placeholder="TMT Jabatan"name="tmt_jabatan" value="<?= $fungsional['tmt_jabatan'] ?>" >
                                    </div>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" name="file_sk" id="filer_example2" value="<?= $fungsional['file_sk'] ?>" >
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                        <?= form_error('file_sk'); ?>
                                    </small>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <a class="btn btn-sm btn-secondary mr-4" href="<?=base_url();?>Profile/index/<?=$fungsional['nip']?>/fungsional">
                                    Kembali
                                </a>
