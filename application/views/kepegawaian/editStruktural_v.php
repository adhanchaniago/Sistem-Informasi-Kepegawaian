                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form enctype="multipart/form-data" method="post">
                            <input type="hidden" name="id_struktural" value="<?=$struktural['id_struktural']?>">
                            <input type="hidden" name="status" value="<?=$struktural['status']?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                     <select name="id_jabatan"class="selectpicker form-control form-control-sm strukturalSelect" data-live-search="true" data-size="6" title="...">
                                         <?php foreach($jabatan as $row) :?>
                                            <?php if ($row['id_jabatan']==$struktural['id_jabatan']) : ?>
                                            <option data-tokens="<?= $row['nm_jabatan']?>" value="<?= $row['id_jabatan']?>" selected>
                                            <?= $row['nm_jabatan']?>
                                            </option>
                                            <?php else : ?>
                                            <option data-tokens="<?= $row['nm_jabatan']?>" value="<?= $row['id_jabatan']?>">
                                            <?= $row['nm_jabatan']?>
                                            <?php endif; ?>
                                            </option>
                                        <?php endforeach; ?>
                            ...
                            <div class="form-group row eselonSelect" <?= checkJabatan($jabatan_struktural) ?>>
                                ...
                                <div class="col-sm-6">
                                     <select name="id_eselon"class="selectpicker form-control form-control-sm" data-live-search="true" data-size="3" title="...">
                                         <?php foreach($eselon as $row) :?>
                                            <?php if ($row['id_eselon']==$struktural['id_eselon']) : ?>
                            ...
                            <div class="form-group row eselonSelect" <?= checkJabatan($jabatan_struktural) ?>>
                                ...
                                <div class="col-sm-9">
                                    <select name="status_struktural" class="selectpicker form-control form-control-sm" data-live-search="true" data-size="3" title="...">
                                        <option value="Aktif" <?=checkOption('Aktif',$struktural['status_struktural'])?>>Aktif</option>
                                        <option value="Non Aktif" <?=checkOption('Non Aktif',$struktural['status_struktural'])?>>Non Aktif</option>
                                    </select>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row eselonSelect" <?= checkJabatan($jabatan_struktural) ?>>
                                ...
                                <div class="col-sm-4">
                                     <input type="text" class="form-control form-control-sm"  placeholder="No SK" name="no_sk" value="<?= $struktural['no_sk'] ?>" >
                                     <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                        <?= form_error('no_sk'); ?>
                                    </small>
                                </div>
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        ...
                                        <input  type="text" class="form-control datepicker form-control-sm" placeholder="Tanggal SK"name="tanggal_sk" value="<?= $struktural['tanggal_sk'] ?>" >
                                    </div>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row eselonSelect" <?= checkJabatan($jabatan_struktural) ?>>
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        ...
                                        <input  type="text" class="form-control datepicker form-control-sm" placeholder="TMT Jabatan"name="tmt_jabatan" value="<?= $struktural['tmt_jabatan'] ?>" >
                                    </div>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row mb-4 eselonSelect" <?= checkJabatan($jabatan_struktural) ?>>
                            ...
                            <div class="row justify-content-center">
                                <a class="btn btn-sm btn-secondary mr-4" href="<?=base_url();?>Profile/index/<?=$struktural['nip']?>/struktural">
                                    Kembali
                                </a>
