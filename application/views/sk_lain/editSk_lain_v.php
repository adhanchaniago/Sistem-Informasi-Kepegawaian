				...
				<div class="col-xl-12">
					<div class="breadcrumb-holder">
						...
						<ol class="breadcrumb float-right">
							...
							<li class="breadcrumb-item"><a href="<?=base_url();?>Profile/index/<?=$sk['nip']?>">
                            Data Pegawai
                            </a> </li>
							<li class="breadcrumb-item active">Edit SK Lainnya</li>
						</ol>
					...
					<div class="card mb-3">
						...
						<div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" value="<?=$sk['no_sk']?>" placeholder="No SK" name="no_sk">
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                        <?= form_error('no_sk'); ?>
                                    </small>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        ...
                                        <input  type="text" class="form-control datepicker form-control-sm" placeholder="Tanggal SK "name="tanggal_sk" value="<?= $sk['tanggal_sk'] ?>" >
                                    </div>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                           ...
                           <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" value="<?=$sk['jenis_sk']?>" placeholder="Jenis SK" name="jenis_sk">
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                        <?= form_error('jenis_sk'); ?>
                                    </small>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                        <textarea class="form-control" rows="3" name="keterangan"><?=$sk['keterangan']?></textarea>
                                        <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="row justify-content-center ">
                                    <a class="btn btn-sm btn-secondary mr-4" href="<?=base_url();?>Profile/index/<?=$sk['nip']?>/sk">
                                        Kembali
                                    </a>
