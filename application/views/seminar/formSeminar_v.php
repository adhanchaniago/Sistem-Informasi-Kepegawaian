					...
					<div class="card mb-3">
						...
						<div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" value="<?=$this->input->post('nama_seminar')?>" placeholder="Nama Seminar" name="nama_seminar">
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="btn-group mb-0" data-toggle="buttons">
                                        <label class="btn btn-primary btn-sm mb-0">
                                            <input type="radio" name="peran" id="option1" autocomplete="off" value="Peserta" > Peserta
                                        </label>
                                        <label class="btn btn-primary btn-sm mb-0">
                                            <input type="radio" name="peran" id="option2" autocomplete="off" value="Narasumber"> Narasumber
                                        </label>
                                        <label class="btn btn-primary btn-sm mb-0">
                                            <input type="radio" name="peran" id="option3" autocomplete="off" value="Moderator"> Moderator
                                        </label>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        ...
                                        <input  type="text" class="form-control datepicker form-control-sm" placeholder="Tanggal Seminar"name="tanggal_seminar" value="<?= $this->input->post('tanggal_seminar') ?>" >
                                    </div>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" value="<?=$this->input->post('tempat_seminar')?>" placeholder="Tempat Seminar" name="tempat_seminar">
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" name="file_seminar" id="filer_example2" value="<?= $this->input->post('file_seminar') ?>" >
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                ...
                                <div class="row justify-content-center ">
                                    <a class="btn btn-sm btn-secondary mr-4" href="<?=base_url();?>Profile/index/<?=$this->input->post('nip')?>/seminar">
                                        Kembali
                                    </a>
