				...
				<div class="col-xl-12">
					<div class="breadcrumb-holder">
						...
						<ol class="breadcrumb float-right">
							...
							<li class="breadcrumb-item active">Add Pelatihan</li>
						</ol>
					...
					<div class="card mb-3">
						...
						<div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <textarea name="nama_diklat" id="" cols="10" rows="3" class="form-control form-control-sm"><?=$this->input->post('nama_diklat')?></textarea>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group date">
                                            ...
                                            <input type='text' class="form-control" name="daterange" value="<?=date("m-d-Y");?>" />	
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" value="<?=$this->input->post('tanda_lulus_diklat')?>" placeholder="Tanda Lulus" name="tanda_lulus_diklat">
                                       <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                ...
                                <div class="form-group row hidePendidikan">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" value="<?=$this->input->post('tempat_diklat')?>" placeholder="Tempat" name="tempat_diklat">
                                       <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                ...
                                <div class="form-group row hidePendidikan">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-sm" value="<?=$this->input->post('negara_diklat')?>" placeholder="Negara " name="negara_diklat">
                                       <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                ...
                                <div class="form-group row hidePendidikan">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" value="<?=$this->input->post('sponsor_diklat')?>" placeholder="Sponsor " name="sponsor_diklat">
                                       <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <textarea name="keterangan" id="" cols="10" rows="3" class="form-control form-control-sm"><?=$this->input->post('keterangan')?></textarea>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" name="file_diklat" id="filer_example2" value="<?= $this->input->post('file_diklat') ?>" >
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                ...
                                <div class="row justify-content-center ">
                                    <a class="btn btn-sm btn-secondary mr-4" href="<?=base_url();?>Profile/index/<?=$this->input->post('nip')?>/pelatihan">
                                        Kembali
                                    </a>
