				...
				<div class="col-xl-12">
					<div class="breadcrumb-holder">
						...
						<ol class="breadcrumb float-right">
							...
							<li class="breadcrumb-item"><a href="<?=base_url();?>Profile/index/<?=$penghargaan['nip']?>">
                            Data Pegawai
                            </a> </li>
					...
					<div class="card mb-3">
						...
						<div class="card-body">
                                ...
                                <div class="col-sm-9">
                                    <select name="nip"class="selectpicker form-control form-control-sm" data-live-search="true" data-size="3" title="...">
                                        <?php foreach($pegawai as $row) :?>
                                            <?php if ($row['nip']==$penghargaan['nip']) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" value="<?=$penghargaan['nama_penghargaan']?>" placeholder="Nama Penghargaan" name="nama_penghargaan">
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        ...
                                        <input  type="text" class="form-control datepicker form-control-sm" placeholder="Tanggal penghargaan"name="tanggal_penghargaan" value="<?= $penghargaan['tanggal_penghargaan'] ?>" >
                                    </div>
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" value="<?=$penghargaan['no_surat']?>" placeholder="No Surat" name="no_surat">
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                        <?= form_error('no_surat'); ?>
                                    </small>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" value="<?=$penghargaan['instansi']?>" placeholder="Instansi" name="instansi">
                                    <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                                        <?= form_error('instansi'); ?>
                                    </small>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                        <textarea class="form-control" rows="3" name="keterangan"><?=$penghargaan['keterangan']?></textarea>
                                        <small id="passwordHelpBlock" class="form-text text-danger mb-0">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="row justify-content-center ">
                                    <a class="btn btn-sm btn-secondary mr-4" href="<?=base_url();?>Profile/index/<?=$penghargaan['nip']?>/penghargaan">
                                        Kembali
                                    </a>
